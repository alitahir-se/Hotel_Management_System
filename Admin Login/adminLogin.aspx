<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="adminLogin.aspx.cs" Inherits="try2.Admin_Login.adminLogin" %>
            ...
            <asp:Label   ID="er2" runat="server" Text=""></asp:Label>
                ...
                OnServerValidate="CustomValidatorPassword_ServerValidate">
					...
					<div class="container-login100-form-btn">
						<asp:Button runat="server" class="login100-form-btn" Text="Login" onclick="Login_admin">
