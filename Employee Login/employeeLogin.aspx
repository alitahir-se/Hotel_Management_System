...
<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="employeeLogin.aspx.cs" Inherits="try2.Employee_Login.employeeLogin" %>
            ...
            <asp:Label   ID="er2" runat="server" Text=""></asp:Label>
                ...
                OnServerValidate="CustomValidatorEmail_ServerValidate">
					...
					<div class="container-login100-form-btn">
						<asp:Button OnClick="Login_check" runat="server" class="login100-form-btn" Text="Login" />
					...
					<div class="text-center p-t-136">
						<a class="txt2" href="../Application/application.aspx">
							Apply for Job
