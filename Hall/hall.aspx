<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="hall.aspx.cs" Inherits="try2.Hall.hall" %>
...
<body>
    ...
    <div>
         <button onclick="document.getElementById('id01').style.display='block'" style="width:auto;">Book a Hall</button>
        ...
        <div class="modal-content animate"  runat="server">
            ...
            <div class="container">
               <label for="Check IN"><b>Check In</b></label>
                <br/> 
                <input type="date" id="chki" class="DropDownList" runat="server" />
                <br/> 
                <label for="Check Out"><b>Check Out</b></label>
                <br/> 
                <input type="date" id="chko" class="DropDownList" runat="server"/>
                <br/> 
                <label for="Category"><b>Category</b></label>
                <br/> 
                <asp:DropDownList ID="DropDownList3" CssClass="DropDownList" runat="server" required>
                ...
                <br/> 
                <asp:DropDownList ID="DropDownList4" CssClass="DropDownList" runat="server" required>
               ...
               <asp:Button runat="server"  Text="Make Reservation" onclick="Reserve_the_hall">
